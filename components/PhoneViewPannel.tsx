...
const PhoneViewPannel = () => {
  ...
  return (
    <Card className="fixed bottom-0 left-0 right-0 z-50 mt-4">
      <CardDescription className="flex justify-between items-center h-full my-4 mx-2 text-gray-700 dark:text-[#A8B3CF]">
        <Link
        ...
        <DrawerTest>
          <div className="p-3 rounded-lg border border-[#A8B3CF]">
            <Plus />
          </div>
        </DrawerTest>
        <Link
        ...
        >
          ...
          <p className="text-xs mt-1">QP's</p>
        </Link>
        <Link
          href="/dashboard"
        ...
        >
          ...
          <p className="text-xs mt-1">Tests Records</p>
        </Link>
      </CardDescription>
    </Card>
  );
