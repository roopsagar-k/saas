...
const CommentSectionInteractionPannel: React.FC<Props> = ({
  ...
  const updateComment = async (
    ...
    console.log("submited message: ", updatedMessage);
  ...
  return (
    <div className="flex mt-4 justify-between">
      <div className="flex gap-4">
        <div onClick={() => updateCommentUpVote()}>
          {!upVote ? (
            <svg
              name="upVote"
        ...
        <div onClick={() => updateCommentDownVote()}>
          {!downVote ? (
            <svg
              name="downVote"
              xmlnsXlink="http://www.w3.org/1999/xlink"
            ...
            <PopoverContent className="m-0">
              <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogTrigger className="w-full">
                  <Button
                    className="flex gap-2 w-full text-[#A8B3CF]  justify-start"
                    variant={"ghost"}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
