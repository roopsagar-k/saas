  ...
  return (
    <div className="w-full h-20 flex gap-2 items-center px-4 justify-between">
        ...
        <div className="relative w-[55%]">
          <form onSubmit={onSearch}>
            <Input
              ...
              className="pl-10 border placeholder:px-4"
            />
          </form>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            className="w-6 h-6 absolute left-3 top-1/2 transform -translate-y-1/2 text-text-tertiary"
          >
            <path
      ...
      <div className="flex items-center gap-4">
        <div className="bg-secondary border-2 border-primary p-2 rounded-md cursor-pointer">
          <svg
